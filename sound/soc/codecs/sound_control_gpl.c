...
#define CAMCORDER_MIC_OFFSET    0
#define HANDSET_MIC_OFFSET      0
#define SPEAKER_OFFSET          0
#define HEADPHONE_L_OFFSET      0
#define HEADPHONE_R_OFFSET      0

#define HEADPHONE_PA_L_OFFSET	0
#define HEADPHONE_PA_R_OFFSET	0
